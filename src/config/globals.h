...
struct Settings {
  ...
  // Doom Fire clock settings. Heights are in fire rows (2 canvas px each).
  uint8_t doomFlameHeight;     // Digit plume reach above the digits (8-40)
  uint8_t doomGroundHeight;    // Ground fire reach (5-40)
